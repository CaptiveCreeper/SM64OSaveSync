...
namespace SM64OSaveSync.Core
{
    public class Mario
    {
        ...
        public LostCap CapLocation { get; set; }
        ...
        {
            Castle = new Level();
            Bob_ombBattlefield = new Level();
            WhompsFortress = new Level();
            JollyRoggerBay = new Level();
            CoolCoolMountain = new Level();
            BoosBigHaunt = new Level();
            HazyMazeCave = new Level();
            LethalLavaLand = new Level();
            ShiftingSandLand = new Level();
            DireDireDocks = new Level();
            SnowmansLand = new Level();
            WetDryWorld = new Level();
            TallTallMountain = new Level();
            TinyHugeIsland = new Level();
            TickTockClock = new Level();
            RainbowRide = new Level();
            BowserDarkWorld = new Level();
            BowserFireSea = new Level();
            BowserSky = new Level();
            PrincessSecretSlide = new Level();
            CaverntOfTheMetalCap = new Level();
            TowerofTheWingCap = new Level();
            VanishCapUnderTheMoat = new Level();
            WingMarioOverTheRainbow = new Level();
            TheSecretAquarium = new Level();
            CapLocation = new LostCap();
        }
    }
}
